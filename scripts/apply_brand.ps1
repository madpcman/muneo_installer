...
function Normalize-Axis {
  ...
  if ($s -eq 'horizontal') { return 'Axis.horizontal' }
  if ($s -eq 'vertical') { return 'Axis.vertical' }
  throw "Invalid axis value: $Value. Expected 'horizontal' or 'vertical'."
}
...
$androidUpdateRequestPackageName = if ($null -ne $config.android_update_request_package_name -and -not [string]::IsNullOrWhiteSpace([string]$config.android_update_request_package_name)) {
  [string]$config.android_update_request_package_name
} elseif ($updateRequestPackageName.EndsWith('_WIN')) {
  $updateRequestPackageName.Substring(0, $updateRequestPackageName.Length - 4) + '_AOS'
} else {
  $updateRequestPackageName
}
...
$authLogoIconFile = if ($null -ne $config.auth_logo_icon_file -and -not [string]::IsNullOrWhiteSpace([string]$config.auth_logo_icon_file)) {
  [string]$config.auth_logo_icon_file
} else {
  'logo_icon.svg'
}
$authLogoIconPath = Join-Path $brandAssetsDir $authLogoIconFile
...
if (-not (Test-Path $authLogoIconPath)) { throw "Missing auth logo icon file in brand assets: $authLogoIconPath" }
...
Update-FileRegex `
  -Path (Resolve-RepoPath 'android/app/src/main/AndroidManifest.xml') `
  -Pattern '(android:name="kr\.co\.grib\.claix\.RemoteControlAccessibilityService"[\s\S]*?android:label=")[^"]+(")' `
  -Replacement '$1@string/remote_control_accessibility_label$2'
...
$remoteControlAccessibilityServiceName = $displayName + ' ' + (Convert-FromCodePoints @(0xC6D0, 0xACA9, 0x0020, 0xC81C, 0xC5B4, 0x0020, 0xC11C, 0xBE44, 0xC2A4))
$remoteControlAccessibilityServiceNameXml = Escape-XmlText $remoteControlAccessibilityServiceName
...
<resources>
    ...
    <string name="remote_control_accessibility_label">$remoteControlAccessibilityServiceNameXml</string>
...
$displayNameDart = Escape-DartString $displayName
$remoteControlAccessibilityServiceNameDart = Escape-DartString $remoteControlAccessibilityServiceName
$brandTextsDart = @"
/// Auto-generated by scripts/apply_brand.ps1
/// Do not edit manually.
class BrandTexts {
  static const String appDisplayName = '$displayNameDart';
  static const String remoteControlAccessibilityServiceName =
      '$remoteControlAccessibilityServiceNameDart';
...
$authLogoDirection = Normalize-Axis $dimensions.auth_logo_direction
$authLogoProductnameHeight = Normalize-PositiveDouble $dimensions.auth_logo_productname_height
$splashAuthLogoHeight = Normalize-PositiveDouble $dimensions.splash_auth_logo_height
$splashAuthLogoProductnameHeight = Normalize-PositiveDouble $dimensions.splash_auth_logo_productname_height
$splashAuthLogoGap = Normalize-NonNegativeDouble $dimensions.splash_auth_logo_gap
...
class BrandLayout {
  ...
  static const Axis authLogoDirection = $authLogoDirection;
  static const double authLogoProductnameHeight = $authLogoProductnameHeight;
  static const double splashAuthLogoHeight = $splashAuthLogoHeight;
  static const double splashAuthLogoProductnameHeight = $splashAuthLogoProductnameHeight;
  static const double splashAuthLogoGap = $splashAuthLogoGap;
}
"@
...
$escapedAndroidUpdateRequestPackageName = Escape-DartString $androidUpdateRequestPackageName
$escapedAuthLogoIconAsset = Escape-DartString ('assets/' + $authLogoIconFile.Replace('\', '/'))
$brandConfigDart = @"
/// Auto-generated by scripts/apply_brand.ps1
/// Do not edit manually.
class BrandConfig {
  ...
  static const String androidUpdateRequestPackageName = '$escapedAndroidUpdateRequestPackageName';
  static const String authLogoIconAsset = '$escapedAuthLogoIconAsset';
}
"@
