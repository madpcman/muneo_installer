...
- PowerShell 작업은 각각 최대 20초, 스마트 앱 컨트롤 정책 갱신은 최대 10초 대기합니다. 시간 초과 시 해당 작업용 프로세스만 종료하고 계속합니다. Defender 예외 등록이 시간 초과되면 나머지 보안 설정도 건너뜁니다. 설치 화면에는 현재 단계와 경과 시간을 표시합니다. 시간 초과는 보안 설정 성공을 의미하지 않으며 이미 요청된 서비스 작업은 일부 적용되었을 수 있습니다.
